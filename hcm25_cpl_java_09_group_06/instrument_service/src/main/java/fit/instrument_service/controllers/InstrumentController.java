...
//    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'LAB_USER')") // Chỉ ADMIN hoặc TECHNICIAN mới được gỡ bỏ thuốc thử
    ...
    public ApiResponse<InstrumentModeResponse> getMode(@PathVariable String id) {
        InstrumentModeResponse response = instrumentService.getInstrumentMode(id);
        return ApiResponse.success(response, "Fetched instrument mode successfully");
    }
}
