...
public class InstrumentServiceImpl implements InstrumentService {
    ...
    @Override
    public InstrumentModeResponse getInstrumentMode(String instrumentId) {
        // Tìm Instrument theo ID
        Instrument instrument = instrumentRepository.findById(instrumentId)
                .orElseThrow(() -> new NotFoundException("Instrument not found with id: " + instrumentId));

        // Tạo và trả về DTO Response
        InstrumentModeResponse response = new InstrumentModeResponse();
        response.setInstrumentId(instrument.getId());
        response.setMode(instrument.getMode());
