...
import fit.instrument_service.dtos.response.InstrumentModeResponse;
...
public interface InstrumentService {
    ...
    /*
     * Lấy thông tin chế độ hoạt động của thiết bị.
     *
     * @param instrumentId ID của thiết bị
     * @return Thông tin chế độ hoạt động của thiết bị
     */
    InstrumentModeResponse getInstrumentMode(String instrumentId);
}
