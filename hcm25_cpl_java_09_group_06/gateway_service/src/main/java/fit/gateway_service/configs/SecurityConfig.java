...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(
                "http://localhost:5173",
                "http://localhost:3001",
                "http://47.129.128.133:3000",
                "http://47.129.128.133:3000/login",
                "http://47.130.67.60:3000",
                "http://47.130.67.60:3000/login",
                "https://laboratory-group-6.vercel.app",
                "https://laboratory-group-6.vercel.app/login"
        ));
