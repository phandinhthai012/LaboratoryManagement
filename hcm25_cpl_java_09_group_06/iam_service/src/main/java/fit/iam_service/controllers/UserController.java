...
public class UserController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize(
            "isAuthenticated() and ( #userId == principal.id or hasRole('ADMIN') or hasRole('LAB_MANAGER') )"
    )
...
//    @PreAuthorize("hasRole('ADMIN')") // Only ADMIN can delete users
    ...
    // --- view detail ---
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN','LAB_MANAGER') or #id == principal.id")
...
//    @PreAuthorize("hasAuthority('USER_CREATE')")
    @PreAuthorize("hasAnyRole('ADMIN', 'LAB_MANAGER') or hasAuthority('USER_CREATE')")
