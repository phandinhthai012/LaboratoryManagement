...
//    @PreAuthorize("hasAnyRole('ROLE_ADMIN','ROLE_MANAGER') or #id == principal.id")
    @PreAuthorize("hasAnyRole('ADMIN', 'LAB_MANAGER') or hasAuthority('ROLE_CREATE')")
    ...
    @PutMapping("/{roleId}")
//    @PreAuthorize("hasAnyRole('ROLE_ADMIN','ROLE_MANAGER') or #id == principal.id")
    @PreAuthorize("hasAnyRole('ADMIN', 'LAB_MANAGER') or hasAuthority('ROLE_UPDATE')")
...
//    @PreAuthorize("hasAnyRole('ROLE_ADMIN','ROLE_MANAGER') or #id == principal.id")
    @PreAuthorize("hasAnyRole('ADMIN', 'LAB_MANAGER') or hasAuthority('ROLE_DELETE')")
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'LAB_MANAGER') or hasAuthority('ROLE_VIEW')")
