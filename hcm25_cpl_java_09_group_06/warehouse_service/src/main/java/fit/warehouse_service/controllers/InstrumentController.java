...
public class InstrumentController {
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('ADMIN','SERVICE','LAB_MANAGER','LAB_USER') or hasAuthority('INSTRUMENT_ADD')")
...
//    @PreAuthorize("hasAnyRole('ADMIN','MANAGER')")
    @PreAuthorize("hasAnyRole('ADMIN','SERVICE', 'LAB_USER')")
    ...
    @PreAuthorize("hasAnyRole('ADMIN','SERVICE') or hasAuthority('INSTRUMENT_ACTIVATE_DEACTIVATE')")
    @PutMapping("/activate")
    ...
    @GetMapping
//    @PreAuthorize("hasAnyRole('ADMIN','MANAGER')")
    @PreAuthorize("hasAnyRole('ADMIN','SERVICE','LAB_MANAGER','LAB_USER') or hasAuthority('INSTRUMENT_VIEW')")
