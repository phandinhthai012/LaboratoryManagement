...
public class ConfigurationController {
     ...
     */
    @PostMapping
    @PreAuthorize("hasAnyRole('ADMIN') or hasAuthority('CONFIG_CREATE')")
...
//    @PreAuthorize("hasAnyRole('ADMIN','MANAGER')")
    @PreAuthorize("hasAnyRole('ADMIN') or hasAuthority('CONFIG_MODIFY')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN') or hasAuthority('CONFIG_VIEW')")
     ...
     */
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN') or hasAuthority('CONFIG_DELETE')")
